...
import 'package:billing_software/const.dart';
...
import '../widgets/backgrount.dart';
import '../widgets/category_item.dart';
import '../widgets/product_image.dart';
import 'EmployeeViewMyBillsScreen.dart';
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                          color: goldAccent, shape: BoxShape.circle),
                    ),
                  ),
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(
              ...
              color: index == currentProduct
                  ? beigeGradientEnd.withOpacity(0.6)
                  : transparent)),
